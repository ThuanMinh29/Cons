...
const CheckoutPage = () => {
  ...
  return (
    <div className="min-h-screen py-4 md:py-10 bg-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
          ...
          <div className="bg-white p-4 md:p-6 rounded-lg">
            ...
            <div>
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 gap-2">
                ...
                <Link
                  to="/login"
                  className="text-blue-600 text-sm hover:underline flex items-center gap-1 self-start sm:self-auto"
                >
                  <svg
              ...
              <div className="space-y-3 md:space-y-4">
                ...
                <div className="relative">
                  ...
                  <div className="absolute right-2 md:right-3 top-1/2 transform -translate-y-1/2 text-gray-500 text-xs pointer-events-none">
                    <ChevronDownIcon />
                  </div>
                </div>
                <div className="relative">
          ...
          <div className="space-y-4 md:space-y-6">
            ...
            <div className="bg-white p-4 md:p-6 rounded-lg">
              ...
              <label className="flex items-center border border-gray-300 rounded-md p-3 md:p-4 cursor-pointer bg-white hover:bg-gray-50 transition-colors">
                ...
                />
                <div
                  className={`w-4 h-4 rounded-full border-2 flex items-center justify-center mr-3 transition-all ${
                    paymentMethod === "cod"
          ...
          <div className="bg-white p-4 md:p-6 rounded-lg">
            ...
            <div className="flex items-center gap-3 md:gap-4 border-b border-gray-200 pb-3 md:pb-4 mb-3 md:mb-4">
              <div className="relative flex-shrink-0">
                <img
                  ...
                  alt="Máy khoan động lực 650w dewalt dwd024k(13mm,0-2800rpm) kèm vali+mui"
              ...
              <div className="flex-grow min-w-0">
                <p className="text-gray-800 text-xs md:text-sm font-medium line-clamp-2">
                  Máy khoan động lực 650w dewalt dwd024k(13mm,0-2800rpm) kèm
                  vali+mui
                </p>
              </div>
              <p className="text-gray-800 text-xs md:text-sm font-medium flex-shrink-0">
                1.650.000đ
              </p>
            </div>
            ...
            <div className="flex items-center gap-3 md:gap-4 border-b border-gray-200 pb-3 md:pb-4 mb-3 md:mb-4">
              <div className="relative flex-shrink-0">
                <img
                  src="https://bizweb.dktcdn.net/thumb/large/100/321/299/products/9624565088286.jpg?v=1531752184130"
                  alt="Bộ dụng cụ vặn vít đa năng 10 chi tiết Bosch 2607019510 (Xanh réu)"
                  className="w-12 h-12 md:w-16 md:h-16 object-cover rounded-md"
                />
                <span className="absolute -top-1 -left-1 md:-top-2 md:-left-2 bg-blue-500 text-white text-xs font-bold rounded-full w-4 h-4 md:w-5 md:h-5 flex items-center justify-center">
                  2
              ...
              <div className="flex-grow min-w-0">
                <p className="text-gray-800 text-xs md:text-sm font-medium line-clamp-2">
                  Bộ dụng cụ vặn vít đa năng 10 chi tiết Bosch 2607019510 (Xanh
                  réu)
                </p>
              </div>
              <p className="text-gray-800 text-xs md:text-sm font-medium flex-shrink-0">
            ...
            <div className="text-sm space-y-2 md:space-y-3 border-t border-gray-200 pt-3 md:pt-4">
              <p className="flex justify-between text-gray-700">
                <span>Tạm tính</span> <span>1.908.000đ</span>
              </p>
              <p className="flex justify-between text-gray-700">
              ...
              <p className="flex justify-between font-bold text-base md:text-lg text-gray-800">
                <span>Tổng cộng</span>{" "}
                <span className="text-blue-600">1.908.000đ</span>
              </p>
            </div>
            ...
            <p className="text-xs md:text-sm mt-3 md:mt-4 text-center text-blue-600 hover:underline cursor-pointer">
              ← Quay về giỏ hàng
            </p>
          </div>
        </div>
